    ...
    public class CoffeeRepository : ICoffeeRepository
    {
        ...
        public List<Coffee> GetAll()
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"SELECT c.Id, c.Title, c.BeanVarietyId, b.Name as 'BeanVarietyName', b.Region as 'BeanVarietyRegion', b.Notes as 'BeanVarietyNotes' 
                                       FROM Coffee c JOIN BeanVariety b on b.Id = c.BeanVarietyId";
                    using (SqlDataReader reader = cmd.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            {
                                coffee.BeanVariety.Notes = reader.GetString(reader.GetOrdinal("BeanVarietyNotes"));
                            }
        ...
        public Coffee Get(int id)
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"
                        SELECT c.Id, c.Title, c.BeanVarietyId, b.Name as 'BeanVarietyName', b.Region as 'BeanVarietyRegion', b.Notes as 'BeanVarietyNotes' 
                        FROM Coffee c JOIN BeanVariety b on b.Id = c.BeanVarietyId
                        WHERE c.Id = @id;";
